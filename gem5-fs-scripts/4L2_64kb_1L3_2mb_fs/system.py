...
class RiscvSystem(System):
    ...
    def createCacheHierarchy(self, num_cpus):
        ...
        self.l2bus1 = L2XBar() #4 adet L2 yi baglamak icin 4 adet bus olusturudk
        self.l2bus2 = L2XBar()
        self.l2bus3 = L2XBar()
        self.l2bus4 = L2XBar()
        ...
        #icache ve dcache l2 buslara baglanir
        self.cpu[0].icache.mem_side = self.l2bus1.cpu_side_ports
        self.cpu[0].dcache.mem_side = self.l2bus1.cpu_side_ports

        self.cpu[1].icache.mem_side = self.l2bus2.cpu_side_ports
        self.cpu[1].dcache.mem_side = self.l2bus2.cpu_side_ports

        self.cpu[2].icache.mem_side = self.l2bus3.cpu_side_ports
        self.cpu[2].dcache.mem_side = self.l2bus3.cpu_side_ports

        self.cpu[3].icache.mem_side = self.l2bus4.cpu_side_ports
        self.cpu[3].dcache.mem_side = self.l2bus4.cpu_side_ports
        ...
        self.cpu[0].mmucache.mem_side = self.l2bus1.cpu_side_ports
        self.cpu[1].mmucache.mem_side = self.l2bus2.cpu_side_ports
        self.cpu[2].mmucache.mem_side = self.l2bus3.cpu_side_ports
        self.cpu[3].mmucache.mem_side = self.l2bus4.cpu_side_ports
            
        # create our four l2 cache and connect it to the L2 bus
        self.l2cache1 = L2Cache()
        self.l2cache2 = L2Cache()
        self.l2cache3 = L2Cache()
        self.l2cache4 = L2Cache()


        self.l2cache1.connectCPUSideBus(self.l2bus1)
        self.l2cache2.connectCPUSideBus(self.l2bus2)
        self.l2cache3.connectCPUSideBus(self.l2bus3)
        self.l2cache4.connectCPUSideBus(self.l2bus4)
        ...
        self.l2cache2.connectMemSideBus(self.l3bus)
        self.l2cache3.connectMemSideBus(self.l3bus)
        self.l2cache4.connectMemSideBus(self.l3bus)
