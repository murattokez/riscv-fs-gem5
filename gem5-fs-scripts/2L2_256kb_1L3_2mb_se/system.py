...
m5.util.addToPath('/home/murattutel/gem5/configs')
...
default_binary = os.path.join(
    'home/murattutel/gem5/tests/test-progs/hello/bin/riscv/linux/hello')
...
system.cpu[2].icache.connectBus(system.l2bus2)
system.cpu[2].dcache.connectBus(system.l2bus2)
...
#binary = '/home/murattutel/Desktop/multi_core_programming_example/omp_mm.riscv'
pargs = []
