...
class RiscvSystem(System):
    ...
    def createCacheHierarchy(self, num_cpus):
        ...
        self.l2bus1 = L2XBar() #2 adet L2 yi baglamak icin 2 adet bus olusturudk
        self.l2bus2 = L2XBar()
        self.l3bus = L2XBar()
        ...
        self.cpu[1].icache.mem_side = self.l2bus1.cpu_side_ports
        self.cpu[1].dcache.mem_side = self.l2bus1.cpu_side_ports

        self.cpu[2].icache.mem_side = self.l2bus2.cpu_side_ports
        self.cpu[2].dcache.mem_side = self.l2bus2.cpu_side_ports

        self.cpu[3].icache.mem_side = self.l2bus2.cpu_side_ports
        self.cpu[3].dcache.mem_side = self.l2bus2.cpu_side_ports
        ...
        self.cpu[1].mmucache.mem_side = self.l2bus1.cpu_side_ports
        self.cpu[2].mmucache.mem_side = self.l2bus2.cpu_side_ports
        self.cpu[3].mmucache.mem_side = self.l2bus2.cpu_side_ports
